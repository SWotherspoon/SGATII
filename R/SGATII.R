...
##' point passes through the corresponding grid point.  If
##' `points=FALSE` the weights are calculated only the contribution to
##' the posterior from the light data alone, but if `points=TRUE` the
##' contributions to the posterior from the track points are also
##' included.
##'
##'
...
##' @param points should the contribution the posterior from the track
##'   points be included.
